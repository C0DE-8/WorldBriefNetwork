...
export const getAccountRequests = () => api('/admin/account-requests')
export const approveAccountRequest = (id) => api(`/admin/account-requests/${id}/approve`, { method:'POST' })
export const rejectAccountRequest = (id) => api(`/admin/account-requests/${id}/reject`, { method:'POST' })
